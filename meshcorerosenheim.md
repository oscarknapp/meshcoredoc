...
In der App und im Web-Konfigurator das Preset **`EU/UK (Narrow)`** wählen. Dieses Preset setzt automatisch alle notwendigen Funkparameter für den Betrieb in Deutschland und Europa. Die einzelnen Werte müssen dann nicht manuell eingetragen werden.

> **Wichtig:** Ohne das richtige Preset kommuniziert das Gerät nicht mit anderen MeshCore-Knoten in Deutschland.

Die folgende Tabelle zeigt die Werte, die das Preset im Hintergrund setzt – zur Referenz und zur manuellen Überprüfung:

| Parameter        | Wert                | Hinweis                              |
|------------------|---------------------|--------------------------------------|
| Frequenzband     | 869 MHz             | EU-ISM-Subband 869.4–869.65 MHz      |
| Frequenz         | 869.618 MHz         | Durch Preset gesetzt                 |
...
*Diese Seite ist eine Community-Ressource und keine offizielle Veröffentlichung des MeshCore-Projekts.# MeshCore Rosenheim – Konfiguration für Neueinsteiger
